  ...
  return (
    <section className="text-gray-600 dark:text-gray-300 body-font bg-white dark:bg-gray-900 transition-colors duration-200">
      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 dark:border-gray-700 sm:flex-row flex-col">
          <div className="sm:w-44 sm:h-32 h-20 w-20 sm:mr-10 inline-flex items-center justify-center rounded-full bg-pink-100 dark:bg-pink-900 text-pink-500 flex-shrink-0">
            {/* Image */}
            <Image
              src="/anuj.jpg"
          ...
          <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0 flex-col">
            <h2 className="text-gray-900 dark:text-white text-2xl title-font font-medium mb-2">
              Anuj Chaudhary
            </h2>
        ...
        <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 dark:border-gray-700 sm:flex-row flex-col">
          ...
          <div className="sm:w-44 sm:order-none order-first sm:h-32 h-20 w-20 sm:ml-10 inline-flex items-center justify-center rounded-full bg-pink-100 dark:bg-pink-900 text-pink-500 flex-shrink-0">
            <Image
              src="/amrit.jpg"
              className="rounded-full"
              layout="intrinsic"
