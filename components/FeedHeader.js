...
function FeedHeader() {
  return (
    <section className="py-8 leading-7 text-gray-900 transition-colors duration-200 bg-white dark:bg-gray-900 sm:py-12 md:py-16 lg:py-24">
      <div className="max-w-6xl px-10 mx-auto border-solid lg:px-12">
        <div className="flex flex-col items-start leading-7 text-gray-900 border-0 border-gray-200 lg:items-center lg:flex-row">
          <div className="box-border flex-1 text-center border-solid sm:text-left dark:text-white">
            <h2 className="m-0 text-4xl font-semibold leading-tight tracking-tight text-left text-black border-0 border-gray-200 sm:text-5xl dark:text-white">
              Add Cases In One Click
            </h2>
            <p className="mt-2 text-xl text-left text-gray-900 border-0 border-gray-200 sm:text-2xl dark:text-white">
